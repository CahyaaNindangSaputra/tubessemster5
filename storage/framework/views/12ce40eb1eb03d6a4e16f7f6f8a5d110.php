...
<body class="d-flex align-items-center justify-content-center min-vh-100 p-3">
    ...
    <div class="container text-center">
        ...
        <div class="qris-card shadow-lg">
            ...
            <h2 class="fw-bold text-dark mb-4">Rp <?php echo e(number_format($order->TOTAL_BAYAR, 0, ',', '.')); ?></h2>
            ...
            <form action="<?php echo e(route('customer.qris.confirm', $order->ID_PESANAN)); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <p class="mt-4 text-white-50 small">Order ID: #<?php echo e($order->ID_PESANAN); ?></p>
    </div>
    ...
    <script>
        ...
        const countdown = setInterval(() => {
            ...
            if (timeLeft <= 0) {
                ...
                setTimeout(() => {
                    window.location.href = "<?php echo e(route('customer.menu')); ?>";
                }, 3000);
            }
...
</html><?php /**PATH C:\xampp\htdocs\riels\riels\resources\views/customer/qris.blade.php ENDPATH**/ ?>