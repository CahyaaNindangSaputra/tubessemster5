...
<body class="d-flex align-items-center min-vh-100 py-4">
    ...
    <div class="container" style="max-width: 500px;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <span class="badge bg-secondary rounded-pill">Meja <?php echo e(session('customer_meja')); ?></span>
        </div>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="cart-item p-3 border-bottom bg-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <?php if(isset($details['foto']) && $details['foto']): ?>
                                    <img src="/images/menu/<?php echo e($details['foto']); ?>" class="rounded-3 me-3" style="width: 50px; height: 50px; object-fit: cover;">
                                <?php else: ?>
                                ...
                                <?php endif; ?>
                                <div>
                                    <h6 class="fw-bold mb-1"><?php echo e($details['name']); ?></h6>
                                    <small class="text-primary fw-bold">Rp <?php echo e(number_format($details['price'], 0, ',', '.')); ?></small>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center bg-light rounded-pill px-2 py-1">
                                ...
                                <span class="mx-3 fw-bold small"><?php echo e($details['quantity']); ?></span>
                                
                                <form action="<?php echo e(route('cart.increase', $id)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?> 
                    ...
                    <div class="p-4 bg-light">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <h4 class="fw-bold text-primary mb-0">Rp <?php echo e(number_format($total, 0, ',', '.')); ?></h4>
                        </div>
                    </div>
                </div>
            </div>

            <form action="<?php echo e(route('customer.checkout')); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
            <div class="text-center py-5">
                ...
                <a href="<?php echo e(route('customer.menu')); ?>" class="btn btn-primary rounded-pill px-4 fw-bold">Lihat Menu</a>
            </div>
        <?php endif; ?>

        <?php if(session('cart') && count(session('cart')) > 0): ?>
            <div class="text-center">
                <a href="<?php echo e(route('customer.menu')); ?>" class="text-decoration-none text-muted small fw-bold">
...
</html><?php /**PATH C:\xampp\htdocs\riels\riels\resources\views/customer/cart.blade.php ENDPATH**/ ?>