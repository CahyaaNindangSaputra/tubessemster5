...
<head>
    ...
    <title>Menu Riels Coffee - Meja {{ session('customer_meja') }}</title>
...
<body>
    ...
    <div class="container py-3 mb-5">
        ...
        <div class="welcome-banner d-flex justify-content-between align-items-center">
            <div>
                <h5 class="fw-bold mb-0">Halo, {{ session('customer_nama') ?? 'Pelanggan' }}! 👋</h5>
        ...
        <div class="tab-content">
            @php $categories = ['makanan' => 'K01', 'minuman' => 'K02', 'snack' => 'K03']; $cartCount = count((array) session('cart')); @endphp
                        ...
                        <div class="card-body pt-0">
                            ...
                            @foreach($p->detail as $item)
                                <div class="d-flex justify-content-between small mb-1">
                                    <span>{{ $item->QTY }}x {{ $item->menu->NAMA_MENU ?? 'Menu Hapus' }}</span>
